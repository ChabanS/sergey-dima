                    ...
                    <div class="col-md-4 col-md-offset-4">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title"><spring:message code="label.singin" /></h3>
                            </div>
                            <div class="panel-body">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder=<spring:message code="label.email" /> name="j_username" type="text">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" placeholder=<spring:message code="label.password" />
